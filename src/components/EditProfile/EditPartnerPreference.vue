<template>
  <div>
      ...
      <div class="card-content">
        ...
        <div class="row form-wrapper">
          ...
          <div class="col-md-4 form-group">
            ...
            <Multiselect
              v-model="partnerPrefrencesData.maritalStatuses"
        ...
        <div class="row form-wrapper">
          ...
          <div class="col-md-4 form-group">
            ...
            <Multiselect
              v-model="partnerPrefrencesData.bodyTypes"
          ...
          <div class="col-md-4 form-group">
            ...
            <Multiselect
              v-model="partnerPrefrencesData.complexions"
          ...
          <div class="col-md-4 form-group">
            ...
            <Multiselect
              v-model="partnerPrefrencesData.languages"
        ...
        <div class="row form-wrapper">
          ...
          <div class="col-md-4 form-group">
            ...
            <Multiselect
              v-model="partnerPrefrencesData.dietTypes"
              :options="dietoptions"
              placeholder="Select or start typing"
              label="dietType"
              track-by="dietId"
          ...
          <div class="col-md-4 form-group">
            ...
            <Multiselect
              v-model="partnerPrefrencesData.drinkTypes"
          ...
          <div class="col-md-4 form-group">
            ...
            <Multiselect
              v-model="partnerPrefrencesData.smokeTypes"
      ...
      <div class="card-content">
        ...
        <div class="row form-wrapper">
          <div class="col-md-5 form-group">
            ...
            <Multiselect
              v-model="partnerPrefrencesData.occupations"
        ...
        <div class="row form-wrapper">
          ...
          <div class="col-md-8 form-group">
            <textarea
              v-validate="{ max: 1000 }"
              v-model="partnerPrefrencesData.expectation"
    ...
    <div class="bottom-buttons">
      ...
      <a href="javascript:void(0);"  class="btn blank-btn" @click="viewProfile(partnerPrefrencesData.memberId)">Reset</a>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapGetters("Profile", ["partnerPrefrencesData"]),
    minageValue: {
      get() {
    ...
    minsalaryValue: {
      get() {
        let minsalaryValue = this.partnerPrefrencesData.minSalary;
        let selectedSalary = this.allSalaryoptions.find(salary => {
          return salary.salaryDesc == minsalaryValue;
        });
        if (selectedSalary) {
          const { salaryId } = selectedSalary;
          if (salaryId)
            var maxSalaryoptions = this.allSalaryoptions.filter(salary => {
              return salary.salaryId > salaryId;
            });
            this.setmaxSalaryoptions(maxSalaryoptions)
        } else {
            this.setmaxSalaryoptions(this.allSalaryoptions)
        }
      ...
      set(newValues) {
        if (newValues) {
          ...
          this.partnerPrefrencesData.minSalary = newValues.salaryDesc;
        } else {
    ...
    maxsalaryValue: {
      get() {
        let maxsalaryValue = this.partnerPrefrencesData.maxSalary;
        let selectedSalary = this.allSalaryoptions.find(salary => {
          return salary.salaryDesc == maxsalaryValue;
        });
        if (selectedSalary) {
          const { salaryId } = selectedSalary;
          if (salaryId)
            var minSalaryoptions = this.allSalaryoptions.filter(salary => {
              return salary.salaryId < salaryId;
            });
            this.setMinSalaryOption(minSalaryoptions)
        } else {
          this.setMinSalaryOption(this.allSalaryoptions)
        }
        return selectedSalary;
      },
      set(newValues) {
        if (newValues) {
          ...
          this.partnerPrefrencesData.maxSalary = newValues.salaryDesc;
        } else {
    ...
    religionValues: {
      get() {
        if (
          this.partnerPrefrencesData.religions &&
          this.partnerPrefrencesData.religions.length
        ) {
          ...
          this.setCastOptions(CasteData)
          return this.partnerPrefrencesData.religions;
        }
        return [];
      },
      set(newValues) {
        // Will work for single select only
        this.partnerPrefrencesData.religions.push({
    ...
    castValues: {
      ...
      set(newValues) {
        ...
        this.partnerPrefrencesData.casts = casts;
        this.partnerPrefrencesData.subCasts = subCasts;
      }
    },
    educationLevelValues: {
      ...
      set(selectedValues) {
        ...
        this.partnerPrefrencesData.educationLevels = educationLevels;
        this.partnerPrefrencesData.degrees = degrees;
      }
    }
  },
  watch: {
  ...
  methods: {
    ...mapActions("Profile", ["updatePartnerPreferencesData", "viewProfile"]),
    ...
    onSaveButtonPress: function() {
      this.$validator.validateAll().then(result => {
        if (result) {         
          this.updatePartnerPreferencesData()
            .then(() => {
    ...
    setCastOptions(castdata) {
      this.casteoptions = castdata;
    },
    setMinSalaryOption(minSalaryoptions) {
      this.minSalaryoptions = minSalaryoptions;
    },
    setmaxHeightOptions(maxHeightOptions) {
      this.maxHeightOptions = maxHeightOptions;
    },
    setminageoptions(minageoptions) {
      this.minageoptions = minageoptions;
    },
    setmaxageoptions(maxageoptions) {
      this.maxageoptions = maxageoptions;
    },
    setmaxSalaryoptions(maxSalaryoptions) {
      this.maxSalaryoptions = maxSalaryoptions;
    },
  }
};
</script>